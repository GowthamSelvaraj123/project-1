...
?>
    ...
    <section class="services-list-section">
        <div class="services-list-header container">
            <h2>Our Services</h2>
            <p>Where collaboration shapes every step. A one-stop creative partner shaping every touchpoint of your brand. From concept to execution, we lead with clarity, consistency, and intent.</p>
        </div>
        ...
        <div class="services-list-grid container">
            <div class="services-list-items">
                ...
                <p class="services-list-hint">(Whenever we hover on the service items, service details will appear on the right.)</p>
            </div>
            ...
            <div class="services-list-preview">
                <div class="services-preview-card">
                    ...
                    <div class="services-preview-content">
                        ...
                        <p class="services-preview-text">We build brand identities as full systems, not just logos. This means defining who your brand is, how it sounds, and how moments across every touchpoint feel consistent and memorable.</p>
    ...
    <section class="approach-section">
        <div class="container">
            ...
            <p class="approach-subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        ...
        <div class="container">
            <div class="listen-header">
                <div>
                    ...
                    <p class="listen-copy">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </div>
            </div>
